...
DROP OR REPLACE TABLE IF EXISTS Teams;
DROP OR REPLACE TABLE IF EXISTS Stadiums;
DROP OR REPLACE TABLE IF EXISTS Players;
DROP OR REPLACE TABLE IF EXISTS Coaches;
DROP OR REPLACE TABLE IF EXISTS Games;
DROP OR REPLACE TABLE IF EXISTS Positions;
DROP OR REPLACE TABLE IF EXISTS TeamsPlayers;
DROP OR REPLACE TABLE IF EXISTS TeamsCoaches;
DROP OR REPLACE TABLE IF EXISTS TeamsGames;
